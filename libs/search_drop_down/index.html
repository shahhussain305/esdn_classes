...
<ul>
<li><a href="//www.jqueryscript.net/form/Searchable-Dropdown-Select-jQuery-Selectstyle/">Download This Plugin</a></li>
...
<div class="container">
<h1>jQuery selectstyle Plugin Demos</h1>
<h2>Light Theme</h2>
...
<h2>Dark Theme</h2>
<select theme="dark" width="400" style="" placeholder="Select Your Favorite" data-search="true">
	<option value="AF">Afghanistan</option>
	<option value="AX">Åland Islands</option>
	<option value="AL">Albania</option>
	<option value="DZ">Algeria</option>
