...
class SMTP_validateEmail {
  ...
  * username of sender
  */
 var $from_user = 'mrxtoz';
 /**
  * Host Name of sender
  */
 //var $from_domain = 'localhost';
 var $from_domain = 'gmail.com';
...
?>
<?php // ----------- Example 1- How to use [Remove multi like comments to make code functional]----------- 
...
//------------ Example 2- Validate a single Email via SMTP --[Remove multi like comments to make code functional]------
// include SMTP Email Validation Class
				/*require_once('smtp_validateEmail.class.php');*/
// the email to validate
